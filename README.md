...
## Extra
In the directory `useful_scripts` there are some tools for changing specific things about the downloaded songs, such as cover image, metadata, etc; and an alternative way to convert a mp4 video to a complete mp3 album. \
\
